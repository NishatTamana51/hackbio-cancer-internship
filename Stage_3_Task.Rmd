...
Using the default parameters in [ShinyGO 0.80](http://bioinformatics.sdstate.edu/go/), for 89 significantly differential expressed genes and a background set of 582 genes, we found the following top 10 enriched KEGG pathways.

```{r, echo=FALSE, fig.width=10, fig.height=10}
knitr::include_graphics("/home/hp/Documents/HackbioCancer/shinyGO/Enrichment_analysis_plot.png")
```
